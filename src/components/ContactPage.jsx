    ...
    <>
      <div className="contact-hero">
        <div>
          ...
          <h1>Let's Open<br /><em>Your Doors.</em></h1>
        </div>
      </div>
      <div className="contact-page-body">
        <div>
          ...
          <h2 className="section-title" style={{ fontSize: 'clamp(2rem, 3.5vw, 2.8rem)' }}>
            The Conversation<br /><em>Starts Here</em>
          </h2>
          <div className="gold-divider"></div>
          <p style={{ fontSize: '0.97rem', lineHeight: 1.8, color: 'var(--white-dim)', marginBottom: '36px' }}>
            Whether you're an investor taking your first step into the startup ecosystem or a seasoned allocator looking for your next great opportunity — iQue CAP is where that journey begins.
          </p>
